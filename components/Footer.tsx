    ...
    <footer className="bg-slate-900 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <a href="https://wa.me/525586009578" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  +52 55 8600 9578
                </a>
              </div>
              <div>
                <div className="text-slate-500 text-xs uppercase tracking-wider mb-1">Ubicación</div>
                <p className="text-slate-400">Lirio 20, Lomas de San Miguel, CP 52928</p>
              </div>
              <a
                href="#contacto"
        ...
        <div className="border-t border-slate-800 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} Orbexa Systems. Todos los derechos reservados.</p>
