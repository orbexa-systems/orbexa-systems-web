    ...
    <footer className="bg-slate-900 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">
                NovaTech<span className="text-blue-400">.</span>
              </span>
            </div>
          ...
          {/* Services */}
          <div>
            <h4 className="text-white font-bold mb-5 text-sm tracking-wide uppercase">Servicios</h4>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-bold mb-5 text-sm tracking-wide uppercase">Navegación</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
          ...
          {/* Contact snippet */}
          <div>
            <h4 className="text-white font-bold mb-5 text-sm tracking-wide uppercase">Contacto Rápido</h4>
            <div className="space-y-4 text-sm">
              <div>
                <div className="text-slate-500 text-xs uppercase tracking-wider mb-1">Email</div>
                <a href="mailto:contacto@novatechsolutions.com" className="text-slate-300 hover:text-blue-400 transition-colors">
                  contacto@novatechsolutions.com
                </a>
              </div>
              <div>
                <div className="text-slate-500 text-xs uppercase tracking-wider mb-1">WhatsApp</div>
                <a href="https://wa.me/15550100000" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  +1 (555) 010-0000
                </a>
              </div>
              <div>
                <div className="text-slate-500 text-xs uppercase tracking-wider mb-1">Ubicación</div>
                <p className="text-slate-400">San Francisco, CA 94107</p>
              </div>
              <a
                href="#contacto"
                onClick={(e) => { e.preventDefault(); scrollTo("#contacto"); }}
                className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm px-5 py-2.5 rounded-xl transition-colors mt-2"
              >
        ...
        <div className="border-t border-slate-800 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} NovaTech Solutions. Todos los derechos reservados.</p>
