...
const testimonials = [
  {
    ...
    comment:
      "NovaTech transformó por completo nuestra plataforma de pagos. El equipo demostró un nivel técnico excepcional, cumplieron cada sprint puntualmente y la calidad del código es impresionante. Superaron todas nuestras expectativas.",
    rating: 5,
    initials: "CM",
    color: "bg-blue-600",
  },
  {
    ...
    company: "RetailMax Colombia",
    comment:
      "Desde el día uno, el equipo de NovaTech entendió nuestro modelo de negocio. Entregaron nuestra plataforma e-commerce en tiempo récord y el resultado fue una solución robusta que aumentó nuestras ventas en un 65%. Totalmente recomendados.",
    rating: 5,
    initials: "AR",
  ...
  },
  {
    ...
    comment:
      "Implementar un sistema hospitalario es extremadamente delicado. NovaTech gestionó la complejidad con madurez, seguridad y profesionalismo. El sistema lleva 2 años en producción sin incidentes críticos. Es una alianza que continuaremos.",
    rating: 5,
    initials: "LH",
    color: "bg-violet-600",
  },
