...
export default function CopilotoTerminos() {
  return (
    <main className="min-h-screen bg-slate-50">
      <header className="bg-slate-800 text-white px-6 py-8 text-center">
        <h1 className="text-2xl font-bold">Términos y Condiciones — Copiloto</h1>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 pb-16">
        <div className="bg-amber-50 border-l-4 border-orange-600 rounded-md px-5 py-4 mb-8 text-orange-900 text-sm font-medium">
          Al descargar o usar Copiloto aceptas estos términos. Si no estás de acuerdo, desinstala la aplicación.
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200">
          <Link href="/copiloto/privacidad" className="text-blue-600 text-sm hover:underline">
