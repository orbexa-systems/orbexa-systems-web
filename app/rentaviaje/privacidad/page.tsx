...
export const metadata: Metadata = {
  title: "Política de Privacidad — RentaViaje",
  description:
    "RentaViaje no recopila ni transmite datos personales. Todo el procesamiento ocurre localmente en tu dispositivo.",
};

const sections = [
  {
    heading: "1. Quiénes somos",
    body: "RentaViaje es una aplicación desarrollada por Orbexa Systems (contacto@orbexasystems.com.mx). La app ayuda a conductores de plataformas de transporte (Uber Driver, DiDi Conductor) a evaluar en segundos si una oferta de viaje es rentable, mostrando un veredicto automático en pantalla.\n\nRentaViaje está diseñada para conductores que operan en México. Los cálculos de rentabilidad utilizan pesos mexicanos (MXN) y están calibrados para tarifas y costos de combustible del mercado mexicano.",
  },
  {
    heading: "2. Información que la app lee y por qué",
    body: "Para funcionar, RentaViaje utiliza el Servicio de Accesibilidad de Android. Este servicio le permite a la app leer el texto visible en la pantalla cuando la aplicación de Uber Driver o DiDi Conductor está activa.\n\nEspecíficamente, la app lee:\n• El monto de la tarifa ofrecida (en pesos mexicanos)\n• La distancia estimada del viaje (km)\n• El tiempo estimado del trayecto (minutos)\n\nEsta información se usa únicamente para calcular la rentabilidad del viaje en el momento y mostrar el resultado en pantalla. No se guarda ni se envía a ningún servidor.",
  },
  {
  ...
  },
  {
    ...
    body: "RentaViaje no comparte ningún dato con terceros. No utilizamos servicios de analítica, publicidad, seguimiento ni redes sociales dentro de la app.",
  },
  {
  ...
  },
  {
    ...
    body: "RentaViaje está dirigida exclusivamente a conductores mayores de edad registrados en plataformas de transporte. No recopilamos conscientemente información de menores.",
  },
  {
...
export default function RentaViajePoliticaPrivacidad() {
  return (
    <main className="min-h-screen bg-slate-50">
      <header className="bg-slate-800 text-white px-6 py-8 text-center">
        <h1 className="text-2xl font-bold">Política de Privacidad — RentaViaje</h1>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 pb-16">
        <div className="bg-green-50 border-l-4 border-green-600 rounded-md px-5 py-4 mb-8 text-green-800 text-sm font-medium">
          RentaViaje no recopila, almacena ni transmite ningún dato personal a servidores externos. Todo el procesamiento ocurre localmente en tu dispositivo.
        </div>
